...
:PROPERTIES:
:header-args: :tangle ~/.config/atuin/catppuccin-macchiato-lavender.toml
:END:

#+begin_src conf
#~/.config/atuin/catppuccin-macchiato-lavender.toml
[theme]
name = "catppuccin-macchiato-lavender"
