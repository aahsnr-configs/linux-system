...
S=${WORKDIR}/apparmor-v4.1.0-beta5/parser

PATCHES=(
	# "${FILESDIR}/apparmor-3.0.5-makefile.patch"
	"${FILESDIR}/apparmor-2.11.1-dynamic-link.patch"
	"${FILESDIR}/apparmor-3.1.4-fix-hardcoded-path.patch"
)
...
src_install() {
	...
	newinitd "${FILESDIR}/apparmor-init-1" ${PN}
